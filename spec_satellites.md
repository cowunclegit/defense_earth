...
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| `laser` | 타겟팅 레이저 위성 | 200 | 5 | Yes | 40 | 0.4s | 250 |
| `emp` | EMP 위성 | 1,000 | 7 | Yes | 480 (2초 스턴) | 3.0s | 400 |
| `plasmaLaser` | 플라즈마 레이저 위성 | 5,000 | 8 | Yes | 3,500 | 5.0s | 450 |
| `gravityBomb` | 중력 포탄 위성 | 25,000 | 9 | Yes | 20,000 | 6.0s | 500 |
| `clusterMissile` | 클러스터 미사일 위성 | 120,000 | 10 | Yes | 35,000 (x3) | 8.0s | 550 |
| `antimatter` | 반물질 미사일 위성 | 600,000 | 15 | Yes | 600,000 (광역) | 15.0s | 650 |
| `sensor` | 조기 경보 센서 위성 | 500 | 8 | No | - | - | - |
| `forceShield` | 포스 실드 위성 | 12,500 | 12 | No | - | - | - |
| `decoy` | 디코이 위성 | 100 | 5 | No | - | - | - |
| `repairDrone` | 수리 드론 위성 | 2,500 | 10 | No | - | - | - |
