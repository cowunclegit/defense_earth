...
# HUD labels & bars
@onready var credits_label = $TopHUD/HUDMargin/HUDContent/ResourcesBar/CreditsPanel/CreditsLabel
@onready var tp_label = $TopHUD/HUDMargin/HUDContent/ResourcesBar/TPPanel/TPLabel
@onready var nanocores_label = $TopHUD/HUDMargin/HUDContent/ResourcesBar/NanocoresPanel/NanocoresLabel
@onready var hp_progress = $TopHUD/HUDMargin/HUDContent/StatusGrid/HPBar/HPProgress
@onready var shield_progress = $TopHUD/HUDMargin/HUDContent/StatusGrid/ShieldBar/ShieldProgress
@onready var power_label = $TopHUD/HUDMargin/HUDContent/StatusGrid/PowerGrid/PowerLabel

# Tab Buttons & Panels
@onready var buildings_btn = $ControlPanelMargin/ControlPanel/PanelMargin/PanelLayout/TabBar/BuildingsBtn
@onready var satellites_btn = $ControlPanelMargin/ControlPanel/PanelMargin/PanelLayout/TabBar/SatellitesBtn
@onready var lab_btn = $ControlPanelMargin/ControlPanel/PanelMargin/PanelLayout/TabBar/LabBtn

@onready var buildings_tab = $ControlPanelMargin/ControlPanel/PanelMargin/PanelLayout/ContentContainer/TabMargin/BuildingsTab
@onready var satellites_tab = $ControlPanelMargin/ControlPanel/PanelMargin/PanelLayout/ContentContainer/TabMargin/SatellitesTab
@onready var lab_tab = $ControlPanelMargin/ControlPanel/PanelMargin/PanelLayout/ContentContainer/TabMargin/LabTab

# Construction buttons
@onready var power_plant_btn = $ControlPanelMargin/ControlPanel/PanelMargin/PanelLayout/ContentContainer/TabMargin/BuildingsTab/PowerPlantBtn
@onready var factory_btn = $ControlPanelMargin/ControlPanel/PanelMargin/PanelLayout/ContentContainer/TabMargin/BuildingsTab/FactoryBtn
@onready var housing_btn = $ControlPanelMargin/ControlPanel/PanelMargin/PanelLayout/ContentContainer/TabMargin/BuildingsTab/HousingBtn
@onready var bunker_btn = $ControlPanelMargin/ControlPanel/PanelMargin/PanelLayout/ContentContainer/TabMargin/BuildingsTab/BunkerBtn

# Satellite buttons
@onready var buy_laser_btn = $ControlPanelMargin/ControlPanel/PanelMargin/PanelLayout/ContentContainer/TabMargin/SatellitesTab/BuyLaserBtn
@onready var buy_emp_btn = $ControlPanelMargin/ControlPanel/PanelMargin/PanelLayout/ContentContainer/TabMargin/SatellitesTab/BuyEmpBtn
@onready var buy_plasma_btn = $ControlPanelMargin/ControlPanel/PanelMargin/PanelLayout/ContentContainer/TabMargin/SatellitesTab/BuyPlasmaBtn
@onready var buy_cluster_btn = $ControlPanelMargin/ControlPanel/PanelMargin/PanelLayout/ContentContainer/TabMargin/SatellitesTab/BuyClusterBtn

# Lab buttons
@onready var credit_gen_upgrade_btn = $ControlPanelMargin/ControlPanel/PanelMargin/PanelLayout/ContentContainer/TabMargin/LabTab/CreditGenUpgradeBtn
@onready var intercept_upgrade_btn = $ControlPanelMargin/ControlPanel/PanelMargin/PanelLayout/ContentContainer/TabMargin/LabTab/InterceptUpgradeBtn
@onready var rebirth_btn = $ControlPanelMargin/ControlPanel/PanelMargin/PanelLayout/ContentContainer/TabMargin/LabTab/RebirthBtn
