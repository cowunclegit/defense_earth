...
* **공격 위성:**
  ...
  * **반물질 미사일 위성:** 600,000 HP 데미지, 8 초 쿨다운, 초고화력 광역 splash 데미지.
* **지원·방어 위성:**
...
* **스폰 거리 및 광역 시야:** 적 함선은 행성 중심부로부터 **반경 1000**의 심우주 경계 영역에서 웜홀을 통해 스폰됩니다. 플레이어는 화면을 줌아웃하여 저 먼 외곽에서부터 적들이 지구 궤도를 향해 천천히 다가오는 움직임을 조망하고 전략적인 대응 시간을 가질 수 있습니다.
