...
* **코르벳 약탈선 (Raider Corvette):**
  * *스펙:* 속도 중상, 체력 중상, 고출력 엔진.
  * *행동 패턴:* 주로 행성 간 무역 수송선이나 인구 이주선을 요격하는 강습함입니다. 수송선에 중력 포획 와이어를 연결하여 웜홀로 견인(약탈)하려 합니다.
  * *대응/공략:* 수송망 호위함대로 배속된 **에스코트 호위함(Frigates)**을 파견하여 빠르게 포획 줄을 끊고 격침시켜야 합니다.
* **아머 멜터 (Armor Melter):**
