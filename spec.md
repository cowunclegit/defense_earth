...
* **B. 탄막 요격형 키네틱 실드 (Flak/SAM Kinetic Shield - 실물 탄환/미사일 방어용):**
  ...
  * **확률적 요격 기믹 (Flak Probability):** 절대 차단 장벽이 아닌, 실제 대공 방어망처럼 **확률적 요격 시스템**으로 작동합니다. 적의 포탄이 너무 과도하게 밀려들거나 기지 방어막 수량이 부족할 경우 요격 한계에 도달해 일부 탄탄 및 미사일을 놓쳐 지상이나 궤도 기지에 직접적인 피해를 허용할 수 있습니다.
  * **성능 향상 조건:** 요격소의 배치 개수가 많거나, 과학소의 연구 및 기지 레벨이 높아질수록 요격탄 사출 속도가 비약적으로 향상되어 최종 요격 성공률(기본 $60\%$ ➔ 최대 $100\%$ 완벽 차단)까지 증대될 수 있습니다.
