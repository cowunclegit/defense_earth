...
export const SATELLITE_SPECS = {
  laser: { name: '타겟팅 레이저 위성', cost: 200, energy: 5, isWeapon: true, dmg: 40, cd: 0.4, range: 250 },
  plasmaLaser: { name: '플라즈마 레이저 위성', cost: 5000, energy: 8, isWeapon: true, dmg: 3500, cd: 5.0, range: 450 },
  ...
  antimatter: { name: '반물질 미사일 위성', cost: 600000, energy: 15, isWeapon: true, dmg: 600000, cd: 8.0, range: 1200 },
...
export const COUNTERATTACK_MODULE_SPECS = {
  reflector: { name: '실드 반사포', energyCost: 10, cost: 150000 },
  discharge: { name: '과부하 방전', energyCost: 10, cost: 150000 },
  electricField: { name: '전기장 역류', energyCost: 15, cost: 200000 }
};
...
export const ENEMY_SPAWN_RADIUS = 1000;
